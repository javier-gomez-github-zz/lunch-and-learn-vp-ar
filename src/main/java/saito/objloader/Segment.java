...
public class Segment {
    ...
    public void setupGL(GL2 gl, Debug debug, PVector[] p, PVector[] t, PVector[] n) {
    ...
    public void beginDrawGL(GL2 gl) {
        gl.glBindBuffer(GL2.GL_ARRAY_BUFFER, glbuf[0]);
        ...
        gl.glVertexPointer(3, GL2.GL_FLOAT, 32, 0);
        gl.glTexCoordPointer(2, GL2.GL_FLOAT, 32, 12);
        gl.glNormalPointer(GL2.GL_FLOAT, 32, 20);
        ...
        // gl.glPolygonMode(GL2.GL_BACK, GL2.GL_POINTS);
        // gl.glEnable(GL2.GL_CULL_FACE);
        //
        // gl.glCullFace(GL2.GL_BACK);
    }

    public void drawGL(GL2 gl, int GLTYPE) {

        beginDrawGL(gl);

        // once I get the indexing better I'll use glDrawElements
        // gl.glDrawElements(GLTYPE , indexIB.capacity(), GL2.GL_UNSIGNED_INT,
        // indexIB);
